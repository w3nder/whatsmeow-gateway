...
| `bad_gateway` | O WhatsApp recusou o pedido por um motivo daquele grupo que não tem código próprio (ex.: pedido inválido — IQ 400, 406 e demais códigos abaixo de 500 que não sejam 401, 403, 404, 410, 423 nem 429) |
